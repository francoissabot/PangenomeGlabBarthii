...
%Description des différents compartiments, mais aussi croisements: gènes/locus délétés en commun SNP density
%Reste à comparer (refaire analyse sur mapping glab/bart sur MSU7, voir avec Christine si elle le fait ou si je le lance), à regarder les positionnnements des variations, gene vs non gene... Aussi regarder les SNP sur genes en focntion des compartiments 
